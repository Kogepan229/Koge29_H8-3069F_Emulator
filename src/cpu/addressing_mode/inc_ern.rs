...
impl<'a> Cpu<'a> {
    ...
    pub(in super::super) fn read_inc_ern_b(
        &mut self,
        register_field: u8,
    ...
    pub(in super::super) fn write_inc_ern_w(
        &mut self,
        register_field: u8,
        value: u16,
    ) -> Result<(), AddressingError> {
    ...
    pub(in super::super) fn read_inc_ern_w(
        &mut self,
        register_field: u8,
    ...
    pub(in super::super) fn write_inc_ern_l(
        &mut self,
        register_field: u8,
        value: u32,
    ) -> Result<(), AddressingError> {
    ...
    pub(in super::super) fn read_inc_ern_l(
        &mut self,
        register_field: u8,
