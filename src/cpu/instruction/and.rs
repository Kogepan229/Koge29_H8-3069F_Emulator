...
impl Cpu {
    pub(in super::super) fn and_b_imm(&mut self, opcode: u16) -> Result<u8> {
    ...
    pub(in super::super) fn and_b_rn(&mut self, opcode: u16) -> Result<u8> {
    ...
    pub(in super::super) fn and_w_imm(&mut self, opcode: u16) -> Result<u8> {
    ...
    pub(in super::super) fn and_w_rn(&mut self, opcode: u16) -> Result<u8> {
        let register_src = Cpu::get_nibble_opcode(opcode, 3)?;
        let register_dest = Cpu::get_nibble_opcode(opcode, 4)?;
    ...
    pub(in super::super) fn and_l_imm(&mut self, opcode: u16) -> Result<u8> {
    ...
    pub(in super::super) fn and_l_rn(&mut self, _opcode: u16, opcode2: u16) -> Result<u8> {
        let mut f = || -> Result<()> {
