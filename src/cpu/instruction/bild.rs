...
impl Cpu {
    ...
    pub(in super::super) async fn bild_ern(&mut self, opcode: u16, opcode2: u16) -> Result<usize> {
    ...
    pub(in super::super) async fn bild_abs(&mut self, opcode: u16, opcode2: u16) -> Result<usize> {
        let imm = Cpu::get_nibble_opcode(opcode2, 3)? & 7;
