...
impl Cpu {
    ...
    pub(in super::super) async fn bnot_ern(&mut self, opcode: u16, opcode2: u16) -> Result<usize> {
    ...
    pub(in super::super) async fn bnot_abs(&mut self, opcode: u16, opcode2: u16) -> Result<usize> {
        match opcode2 & 0xff0f {
            0x7100 => {
                let imm = Cpu::get_nibble_opcode(opcode2, 3)? & 7;
