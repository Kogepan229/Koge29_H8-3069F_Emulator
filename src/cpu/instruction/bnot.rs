...
impl Cpu {
    pub(in super::super) fn bnot_rn_from_imm(&mut self, opcode: u16) -> Result<u8> {
    ...
    pub(in super::super) fn bnot_rn_from_rn(&mut self, opcode: u16) -> Result<u8> {
    ...
    pub(in super::super) fn bnot_ern(&mut self, opcode: u16, opcode2: u16) -> Result<u8> {
    ...
    pub(in super::super) fn bnot_abs(&mut self, opcode: u16, opcode2: u16) -> Result<u8> {
        match opcode2 & 0xff0f {
            0x7100 => {
                let imm = Cpu::get_nibble_opcode(opcode2, 3)? & 7;
