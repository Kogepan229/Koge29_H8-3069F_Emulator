...
impl Cpu {
    pub(in super::super) fn extu_w(&mut self, opcode: u16) -> Result<u8> {
    ...
    pub(in super::super) fn extu_l(&mut self, opcode: u16) -> Result<u8> {
        let register = Cpu::get_nibble_opcode(opcode, 4)?;
...
mod tests {
    ...
    fn test_extu_w() {
        ...
        cpu.ccr = 0b00001110;
        cpu.bus.memory[0..2].copy_from_slice(&[0x17, 0x50]);
        ...
        cpu.pc = MEMORY_START_ADDR;
        cpu.ccr = 0b00001110;
        cpu.bus.memory[0..2].copy_from_slice(&[0x17, 0x5f]);
    ...
    fn test_extu_l() {
        ...
        cpu.pc = MEMORY_START_ADDR;
        cpu.ccr = 0b00001110;
        cpu.bus.memory[0..2].copy_from_slice(&[0x17, 0x70]);
        ...
        cpu.pc = MEMORY_START_ADDR;
        cpu.ccr = 0b00001110;
        cpu.bus.memory[0..2].copy_from_slice(&[0x17, 0x77]);
