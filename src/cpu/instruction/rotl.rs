...
mod tests {
    ...
    fn test_rotl_b() {
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x12, 0x80]);
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x12, 0x8f]);
    ...
    fn test_rotl_w() {
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x12, 0x90]);
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x12, 0x9f]);
    ...
    fn test_rotl_l() {
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x12, 0xb0]);
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x12, 0xb7]);
