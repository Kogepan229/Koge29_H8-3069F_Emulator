...
impl Cpu {
    pub(in super::super) async fn rotxl_b(&mut self, opcode: u16) -> Result<u8> {
    ...
    pub(in super::super) async fn rotxl_w(&mut self, opcode: u16) -> Result<u8> {
        let register = Cpu::get_nibble_opcode(opcode, 4)?;
    ...
    pub(in super::super) async fn rotxl_l(&mut self, opcode: u16) -> Result<u8> {
        let register = Cpu::get_nibble_opcode(opcode, 4)?;
