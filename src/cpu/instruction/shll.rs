...
impl Cpu {
    pub(in super::super) fn shll_b(&mut self, opcode: u16) -> Result<u8> {
    ...
    pub(in super::super) fn shll_w(&mut self, opcode: u16) -> Result<u8> {
        let register = Cpu::get_nibble_opcode(opcode, 4)?;
    ...
    pub(in super::super) fn shll_l(&mut self, opcode: u16) -> Result<u8> {
        let register = Cpu::get_nibble_opcode(opcode, 4)?;
