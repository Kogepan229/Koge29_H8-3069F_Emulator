...
mod tests {
    ...
    fn test_shll_b() {
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x10, 0x00]);
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x10, 0x0f]);
    ...
    fn test_shll_w() {
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x10, 0x10]);
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x10, 0x1f]);
    ...
    fn test_shll_l() {
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x10, 0x30]);
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x10, 0x37]);
