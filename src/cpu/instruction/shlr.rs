...
mod tests {
    ...
    fn test_shlr_b() {
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x11, 0x00]);
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x11, 0x0f]);
    ...
    fn test_shlr_w() {
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x11, 0x10]);
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x11, 0x1f]);
    ...
    fn test_shlr_l() {
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x11, 0x30]);
        ...
        cpu.mcu.memory[0..2].copy_from_slice(&[0x11, 0x37]);
